...
inputdf = read.csv("data/s2_CorrAuthorsVsDecisionTime.csv", fileEncoding="UTF-8-BOM")
...
inputDF <- read.csv("data/intermediatefiles/s2_CorrespondingAuthorVsPrescreen.csv")
...
peer review" for female first authors is `r toString(round(femalesuccessrate,2))`% and for first author males it is `r toString(round(malesuccessrate,2))`%. This difference is `r significance ` chisq( `r toString(chisq$parameter
